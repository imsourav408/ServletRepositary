...
public class BandhanBank implements Bank {
	private static String BankName="Bandhan Bank";
	private static String IFSC="BB123RUP";
	private String accHName;
	private long accNo;
	private long mob;
	private long aadharNo;
	private double amount;
	public BandhanBank() throws IllegalArgumentException {
		String accNo="";
		for(int i=0;i<10;i++) {
